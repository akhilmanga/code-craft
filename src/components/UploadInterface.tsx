      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold text-black mb-4">GitHub Repository</h3>
            <div className="space-y-4">
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-4 border rounded-lg focus:ring-2 focus:ring-black focus:border-transparent outline-none transition-all duration-300 ${
                ...
                />
                {githubUrl && !isValidGitHubUrl(githubUrl) && (
                  <p className="text-red-500 text-sm mt-1">Please enter a valid GitHub repository URL</p>
                )}
              </div>
          ...
          {/* Document URL */}
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold text-black mb-4">Protocol Documentation</h3>
            <div className="space-y-4">
              <div className="relative">
                ...
                />
                {documentUrl && !isValidUrl(documentUrl) && (
                  <p className="text-red-500 text-sm mt-1">Please enter a valid documentation URL</p>
                )}
              </div>
              <div className="text-sm text-gray-500">
        ...
        <div className="text-center mb-8">
          <button
            ...
            className="px-12 py-4 bg-black text-white rounded-lg hover:bg-gray-800 disabled:bg-gray-300 disabled:cursor-not-allowed transition-all duration-300 font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 disabled:transform-none"
          >
        ...
        {uploadState.status !== 'idle' && (
          <div className="p-6 rounded-xl border border-gray-200 bg-gray-50 mb-8">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="font-medium text-black">{uploadState.message}</p>
                {uploadState.status === 'complete' && (
                ...
                {uploadState.status === 'processing' && uploadState.progress && (
                  <div className="mt-2">
                    ...
                    <p className="text-xs text-gray-500 mt-1">{uploadState.progress}% complete</p>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-6 rounded-xl bg-gray-50 border border-gray-200">
            ...
            <h4 className="font-semibold text-black mb-2">Smart Contract Analysis</h4>
            <p className="text-gray-600 text-sm">Deep code analysis, AST parsing, vulnerability detection, and architecture mapping</p>
          </div>
          ...
          <div className="text-center p-6 rounded-xl bg-gray-50 border border-gray-200">
            ...
            <h4 className="font-semibold text-black mb-2">RAG Document Processing</h4>
            <p className="text-gray-600 text-sm">Advanced NLP-powered protocol understanding with context-aware analysis</p>
          </div>
          ...
          <div className="text-center p-6 rounded-xl bg-gray-50 border border-gray-200">
            ...
            <h4 className="font-semibold text-black mb-2">Synthesis & Insights</h4>
            <p className="text-gray-600 text-sm">Combined analysis for comprehensive protocol understanding and security assessment</p>
          </div>
        </div>

        {/* Feature Highlight */}
        <div className="mt-12 text-center">
          <div className="inline-flex items-center space-x-2 px-6 py-3 bg-black/5 rounded-full">
        ...
        {!import.meta.env.VITE_GITHUB_TOKEN && (
          <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-medium text-yellow-800">GitHub API Rate Limits</h4>
                <p className="text-sm text-yellow-700 mt-1">
                  For better performance and higher rate limits, consider providing a GitHub Personal Access Token 
                  by setting the <code className="bg-yellow-100 px-1 rounded">VITE_GITHUB_TOKEN</code> environment variable.
                </p>
              </div>
            </div>
          </div>
